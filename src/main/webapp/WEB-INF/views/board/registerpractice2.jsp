...
<script>
    ...
    document.querySelector("#submitBtn").addEventListener("click",(e)=>{
        e.stopPropagation()//기본동작 막아두기
        e.preventDefault()
        //현재 화면에 있는 파일 정보를 hidden태그들로 변화시키기
        const form1 = document.querySelector("#form1")
        const fileDivArr = uploadResultDiv.querySelectorAll("div")//배열이니까 querySelectorAll,
        //// 이 배열의 크기는 첨부파일의 갯수임. 첨부파일하나당div하나니까

        if(!fileDivArr){//이 배열이 없다면,,
            form1.submit()
            return//돌아가기
        }
        //있다면
        ...
        document.querySelector(".temp").ineerHTML =str
        //form1.innerHTML += str
        form1.submit()
        //form을 submit
